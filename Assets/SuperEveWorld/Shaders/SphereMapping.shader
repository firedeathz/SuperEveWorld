Shader "GLSL Sphere Environmnent Mapping" {
	Properties {
    	...
    	Pass {   
	        ...
	        {            
	            ...
	            mat4 modelMatrixInverse = _World2Object;
	 			...
	 			vec3 r = reflect(u,n);
	 			float m = 0.5 * inversesqrt(r.x*r.x + r.y*r.y + (r.z+1.0)*(r.z+1.0));
	 			textureCoordinates.xy = r.xy * m + 0.5;
	        ...
	        void main()
	        {
	            ...
	            gl_FragColor = vec4(ambColor*2 + diffColor*2 + specColor*2,1.0) + _ReflectColor * 2 * encodedNormal * texture2D(_Sphere, textureCoordinates.xy);
	        }
